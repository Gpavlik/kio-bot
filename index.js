...
async function reloadOrdersFromSheet() {
  try {
    const res = await axios.get('https://script.google.com/macros/s/AKfycbzE9lbUJ-GGb_x9VqFV4tZID5PGUaG_6cRGRG6Nhp-Ls7UrBOoqf6k7zLlhwE621u61/exec', {
...
async function syncUsersFromSheet() {
  try {
    const response = await axios.get('https://script.google.com/macros/s/AKfycbzE9lbUJ-GGb_x9VqFV4tZID5PGUaG_6cRGRG6Nhp-Ls7UrBOoqf6k7zLlhwE621u61/exec?action=getUsers');
...
bot.onText(/📜 Історія замовлень/, async (msg) => {
  ...
  try {
    const res = await axios.post('https://script.google.com/macros/s/AKfycbzE9lbUJ-GGb_x9VqFV4tZID5PGUaG_6cRGRG6Nhp-Ls7UrBOoqf6k7zLlhwE621u61/exec', {
      action: 'getHistory',
      chatId
    });
...
bot.onText(/📊 Статистика/, async (msg) => {
  ...
  try {
    const [orderRes, userRes] = await Promise.all([
      axios.get('https://script.google.com/macros/s/AKfycbzE9lbUJ-GGb_x9VqFV4tZID5PGUaG_6cRGRG6Nhp-Ls7UrBOoqf6k7zLlhwE621u61/exec?action=getStats', {
        params: { action: 'getStats' }
      }),
      axios.get('https://script.google.com/macros/s/AKfycbzE9lbUJ-GGb_x9VqFV4tZID5PGUaG_6cRGRG6Nhp-Ls7UrBOoqf6k7zLlhwE621u61/exec?action=getUserOrderStats', {
...
bot.on('callback_query', async (query) => {
  ...
  const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbzE9lbUJ-GGb_x9VqFV4tZID5PGUaG_6cRGRG6Nhp-Ls7UrBOoqf6k7zLlhwE621u61/exec';
...
if (userIsAdmin && pendingTTN[chatId]) {
  ...
  try {
    await axios.post('https://script.google.com/macros/s/AKfycbzE9lbUJ-GGb_x9VqFV4tZID5PGUaG_6cRGRG6Nhp-Ls7UrBOoqf6k7zLlhwE621u61/exec', {
      action: 'updateTTN',
      timestamp: order.timestamp,
      chatId: targetId,
      ttn: text,
