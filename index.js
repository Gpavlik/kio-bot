...
async function syncUsersFromSheet() {
  try {
    const response = await axios.get('https://script.google.com/macros/s/AKfycbyN0eFGdNuF9p4HPLEVLVRzWUjjZrHOnU-CyZM23QOsKhFLK0SjVO0HUsxxz0o5f3-6/exec?action=getUsers');
...
bot.onText(/📜 Історія замовлень/, async (msg) => {
  ...
  try {
    const res = await axios.post('https://script.google.com/macros/s/AKfycbyN0eFGdNuF9p4HPLEVLVRzWUjjZrHOnU-CyZM23QOsKhFLK0SjVO0HUsxxz0o5f3-6/exec', {
      action: 'getHistory',
      chatId
    });
...
bot.onText(/📊 Статистика/, async (msg) => {
  ...
  try {
    const [orderRes, userRes] = await Promise.all([
      axios.post('https://script.google.com/macros/s/AKfycbyN0eFGdNuF9p4HPLEVLVRzWUjjZrHOnU-CyZM23QOsKhFLK0SjVO0HUsxxz0o5f3-6/exec', { action: 'getStats' }),
      axios.post('https://script.google.com/macros/s/AKfycbyN0eFGdNuF9p4HPLEVLVRzWUjjZrHOnU-CyZM23QOsKhFLK0SjVO0HUsxxz0o5f3-6/exec', { action: 'getUserOrderStats' })
    ]);
...
bot.on('callback_query', async (query) => {
  ...
  const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbyN0eFGdNuF9p4HPLEVLVRzWUjjZrHOnU-CyZM23QOsKhFLK0SjVO0HUsxxz0o5f3-6/exec';
  ...
  if (data.startsWith('verify_')) {
    ...
    try {
      await axios.post('https://script.google.com/macros/s/AKfycbyN0eFGdNuF9p4HPLEVLVRzWUjjZrHOnU-CyZM23QOsKhFLK0SjVO0HUsxxz0o5f3-6/exec', {
        action: 'addUser',
        name: request.name,
